 ...
 * @Last Modified time: 2019-04-23 16:26:50
 */
                        ...
                        if (this._mounted) {
                            if (result.success) {
                                this.setState({ message: 'Profile Picture Changed Successfully ', showSnackbarState: true, variant: 'success', profilePicSrc: '', profilePicUrl: result.data.image, isProgress: false }, () => {
                                    this.props.updateProfilePic(this.state.profilePicUrl)
                                })
                ...
                <DialogContent className="modal-body">
                    ...
                    {this.state.profilePicSrc === '' &&
                        <div className="cover-pic-preview">
                            <img alt="Profile Pic" src={profilePicUrl === '' ? '/assets/images/user.png' : profilePicUrl} className="img-responsive" />
                        </div>
                    }
                    ...
                    <div className="text-right upload-btn">
                        ...
                        {/* {this.state.isProgress && <Button className="btn btn-gray btn-md mrR15" onClick={this.cancelUploading}>Cancel</Button>} */}
...
module.exports = withRouter((connect(null, mapDispatchToProps)(ProfilePicture)));