...
class Compliance extends PureComponent {
    ...
    render() {
        ...
        const { cloud_accounts, selected_cloud_account, selected_control, selected_compliance, date, time, compliaceList, isOpen, selectedCloudAccount, companyAccount } = this.state
        return (
...
const mapDispatchToProps = (dispatch) => {
    return {
        actions: bindActionCreators(Object.assign({}, complianceActions, accountMgmtAction), dispatch),
