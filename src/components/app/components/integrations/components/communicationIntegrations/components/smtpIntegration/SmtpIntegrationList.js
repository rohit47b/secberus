...
class SmtpIntegrationList extends PureComponent {
    _mounted = false
    ...
    fetchIntegrationList() {
        this.props.actions.fetchIntegrationsSmtp().
          then(result => {
...
export default withRouter((connect(null, mapDispatchToProps)(SmtpIntegrationList)));