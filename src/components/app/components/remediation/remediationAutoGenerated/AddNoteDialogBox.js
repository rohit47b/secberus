    ...
    return (
        ...
        {alert !== undefined &&
            ...
            >
                ...
                />
                    <div>
                        <span className="alert-list-title"><strong>Alert ID :</strong></span>
                        <span>
                            {alert.id}
                        </span>
                    </div>
                    <div>
                        <span className="alert-list-title"><strong>Priority :</strong></span>
                        <span>
                            {alert.rule.priority.name}
                        </span>
                    </div>
                    <div>
                    ...
                    <div>
                        <span className="alert-list-title"> <strong>Exposure :</strong></span>
                        <span>
                           {exposure.toLocaleString()}
                        </span>
                    </div>
                    <div>
                        <span className="alert-list-title"><strong>Region :</strong></span>
                        <span>
                            {alert.asset.data.region}
                        </span>
                    </div>
