...
class UserActivityNotificationList extends PureComponent {
    _mounted = false
    ...
    getRows() {
        return [
            {
                event_name: 'New User',
                event_description: 'Triggers when a new user account is created under a Secberus account.',
                notification_type: ['Select Recipients'],
                isEnable:false
            },
            {
                event_name: 'User Deleted',
                event_description: 'Triggers when a user account is removed from a Secberus account.',
                notification_type: ['Select Recipients'],
                isEnable:false
            },
            {
                event_name: 'User password Changed',
                event_description: 'Triggers when a user account has their password updated.',
                notification_type: ['Select Recipients'],
                isEnable:false
            },
            {
                event_name: 'User Login',
                event_description: 'Triggers when a user logs into Secberus.',
                notification_type: ['Select Recipients'],
                isEnable:false
            }
        ];
...
export default UserActivityNotificationList;