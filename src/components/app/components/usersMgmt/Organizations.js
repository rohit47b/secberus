 ...
 * @Last Modified time: 2019-04-04 14:39:15
 */
...
class Organizations extends PureComponent {
    ...
    getRows(num) {
        ...
        return [...Array(num).keys()].map(a => ({
            ...
            name: organizations[Math.floor(Math.random() * 3)],
    ...
    actionCellRenderer  = ({ rowData, cellData }) => {
        return (<div>
            <span className="fnt-16 text-gray mrR10" style={{ cursor: "pointer" }} onClick={() => this.openEditOrganization(rowData)}>
            ...
            <div className="container">
               <Grid container spacing={24} className="mrB0">
                    <Grid item xs={12} md={2}>
                        <BorderBox content={<span className="d-flex align-item-center">Total Organizations <span className="count mrL15">15</span></span>} />
                    </Grid>
                    <Grid item xs={12} md={10} className="d-flex align-item-flex-end justify-flex-end">
                        <div className="d-flex justify-flex-end">
                            <Button
                                ...
                                variant="contained"
                                color="primary"
                                onClick={()=>this.openEditOrganization({})}
                            >
                                Add Organization
                        </Button>
                                ...
                                {({ onRowsRendered, registerChild }) => (
                                    ...
                                    >
                                        ...
                                        <Column
                                            ...
                                            label="Users"
                                            headerRenderer={headerRenderer}
                                            cellRenderer={this.anchorArrayCellRenderer}
                                            disableSort={false}
                                            width={200}
                                            flexGrow={4}
                                        />
