...
class LambdaAssetList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'function_name') {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(LambdaAssetList))