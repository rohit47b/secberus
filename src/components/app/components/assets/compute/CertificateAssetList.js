...
class CertificateAssetList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'domain_name') {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CertificateAssetList))