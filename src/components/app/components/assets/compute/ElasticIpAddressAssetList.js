...
class ElasticIpAddressAssetList extends PureComponent {
            ...
            then(result => {
                if (typeof result !== 'string') {
                    result.forEach(function (type) {
                        if (type.name === 'ec2_elastic_ip_address') {
                            assetType = type.id
                        }
                    });
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="network_interface_owner_id"
                                        label="Owner"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.validateCellData}
                                        disableSort={false}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ElasticIpAddressAssetList))