...
class VolumeAssetList extends PureComponent {
    ...
    instanceCellRenderer = ({...params}) => {
        let cellData = params.cellData
        if (cellData === undefined || cellData === null || cellData.length === 0) {
            cellData = ['no instances']
        } else {
            cellData = cellData
        }
        let component = (
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="attached_instance_id"
                                        label="Attached Instance ID"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.instanceCellRenderer}
                                        disableSort={false}
                                        width={120}
                                        flexGrow={2}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(VolumeAssetList))