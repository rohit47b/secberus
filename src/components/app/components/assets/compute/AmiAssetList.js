...
import { publicPrivateIconCellRenderer, yesNoIconCellRenderer } from 'TableHelper/cellRenderer';
...
class AmiAssetList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'image_id') {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="tags"
                                        label={<span>Tags <i className="fa fnt-10 mrL5" aria-hidden="true"></i></span>}
                                        headerRenderer={this.headerRenderer}
                                    ...
                                    <Column
                                        ...
                                        label="Public"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.publicPrivateCellRenderer}
                                        disableSort={false}
                                        width={120}
                                        flexGrow={4}
                                    />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AmiAssetList))