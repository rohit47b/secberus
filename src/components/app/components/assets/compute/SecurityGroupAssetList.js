...
class SecurityGroupAssetList extends PureComponent {
            ...
            then(result => {
                if (typeof result !== 'string') {
                    result.forEach(function (type) {
                        if (type.name === 'ec2_security_group') {
                            assetType = type.id
                        }
                    });
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SecurityGroupAssetList))