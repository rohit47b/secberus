...
class PolicyAssetList extends PureComponent {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="policy_groups"
                                        label="Groups"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.groupCellRenderer}
                                        disableSort={false}
                                        width={100}
                                        flexGrow={2}
                                    />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PolicyAssetList))