...
class UserAssetList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'username') {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(UserAssetList))