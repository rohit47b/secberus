...
class RoleAssetList extends PureComponent {
    ...
    policyCellRenderer = ({...params}) => {
        let cellData = params.cellData
        if (cellData === undefined || cellData === null || cellData.length === 0) {
            cellData = ['no policies']
        }
        let component = (
            <div>
                {cellData.map((item, index) => {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="role_policies"
                                        label={<span>Policies <i className="fa fa-plus fnt-10 mrL5" aria-hidden="true"></i></span>}
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.policyCellRenderer}
                                        disableSort={false}
                                        width={120}
                                        flexGrow={2}
                                    />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RoleAssetList))