...
class S3BucketPolicyStmtAssetListAssetList extends PureComponent {
            ...
            then(result => {
                if (typeof result !== 'string') {
                    result.forEach(function (type) {
                        if (type.name === 's3_bucket_policy_stmt') {
                            assetType = type.id
                        }
                    });
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(S3BucketPolicyStmtAssetListAssetList))