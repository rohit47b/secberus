...
class RdsAssetList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'instance_identifier') {
    ...
    headerRenderer = ({ dataKey, label, sortBy, sortDirection }) => {
        ...
        if (dataKey === 'instance_identifier') {
            if (sortBy === dataKey) {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RdsAssetList))