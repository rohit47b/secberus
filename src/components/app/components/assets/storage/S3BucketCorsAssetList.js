...
class S3BucketCorsAssetList extends PureComponent {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="allowed_methods"
                                        label="Allowed Methods"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.methodCellRenderer}
                                        disableSort={false}
                                        width={80}
                                        flexGrow={4}
                                    />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(S3BucketCorsAssetList))