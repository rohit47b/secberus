...
class DynamoAssetList extends PureComponent {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="continuous_backups_status"
                                        label="Continuous Backups"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.validateCellData}
                                        disableSort={false}
                                        width={100}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(DynamoAssetList))