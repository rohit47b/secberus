...
class RedshiftParametergroupAssetList extends PureComponent {
            ...
            then(result => {
                if (typeof result !== 'string') {
                    result.forEach(function (type) {
                        if (type.name === 'redshift_parameter_group') {
                            assetType = type.id
                        }
                    });
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="parameter_group_family"
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RedshiftParametergroupAssetList))