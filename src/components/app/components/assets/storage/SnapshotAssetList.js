...
class SnapshotAssetList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'db_snapshot_identifier') {
    ...
    headerRenderer = ({ dataKey, label, sortBy, sortDirection }) => {
        ...
        if (dataKey === 'db_snapshot_identifier') {
            if (sortBy === dataKey) {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="db_snapshot_identifier"
                                        label="Identifier"
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SnapshotAssetList))