...
class RdsBackupList extends PureComponent {
    ...
    sort = ({ sortBy, sortDirection }) => {
        if (sortBy === 'score' || sortBy === 'backup_instance_identifier') {
    ...
    headerRenderer = ({ dataKey, label, sortBy, sortDirection }) => {
        ...
        if (dataKey === 'backup_instance_identifier') {
            if (sortBy === dataKey) {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(RdsBackupList))