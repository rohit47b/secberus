...
class Route53ZoneAssetList extends PureComponent {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="resource_record_set_count"
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Route53ZoneAssetList))