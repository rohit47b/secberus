...
import { yesNoIconCellRenderer, publicPrivateIconCellRenderer } from 'TableHelper/cellRenderer';
import LabelWithHelper from 'hoc/Label/LabelWithHelper'
import history from 'customHistory'

class QueueAssetList extends PureComponent {
    ...
    anchorCellRenderer = ({...params}) => {
        let component = (
            <div>
                <a  onClick={() => history.push({pathname: '/app/assets/detail/' + params.rowData.id, state: {backUrl: '/app/assets-transit', backUrlState: {value: this.props.value}}})} href="javascript:void(0)">{params.cellData}</a>
            </div>
        );
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="approximate_number_of_messages"
                                    ...
                                    <Column
                                        dataKey="approximate_number_of_messages_delayed"
                                    ...
                                    <Column
                                        dataKey="approximate_number_of_messages_not_visible"
                                        label="Messages Not Visible"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.validateCellData}
                                        disableSort={false}
                                        width={100}
                                    ...
                                    <Column
                                        dataKey="message_retention_period"
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(QueueAssetList))