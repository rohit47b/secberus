...
class CloudFrontDistributionCacheAssetList extends PureComponent {
            ...
            then(result => {
                if (typeof result !== 'string') {
                    result.forEach(function (type) {
                        if (type.name === 'cf_distribution_behavior') {
                            assetType = type.id
                        }
                    });
                    if (assetType) {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CloudFrontDistributionCacheAssetList))