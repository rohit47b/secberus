...
class CloudFrontDistributionAssetList extends PureComponent {
                        ...
                        >
                            {({ onRowsRendered, registerChild }) => (
                                ...
                                >
                                    ...
                                    <Column
                                        dataKey="certificate_minimum_protocol"
                                    ...
                                    <Column
                                        ...
                                        label="Enabled"
                                        headerRenderer={this.headerRenderer}
                                        cellRenderer={this.enabledDisabledCellRenderer}
                                        disableSort={false}
                                        width={120}
                                        flexGrow={4}
                                    />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CloudFrontDistributionAssetList))